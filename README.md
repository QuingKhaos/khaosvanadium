...
Vanadium is mineable with water. Vanadium carbide can only be made in stone or steel furnaces or, if [Foundry](https://mods.factorio.com/mod/khaosfoundry) is enabled, with coke in any furnace or the foundry. If you prefer to play without biters and not produce military science, there's a mod setting to allow the rocketry tech to be researched without military science.

## Remarks

This revamp drops support for overhaul mods completely. Adding recycler and/or quality mod should be possible. The focus lies at the moment to provide a consistent experience for the base game. Space Age support will be added in the future (and thus the change from tungsten to vanadium), as well as support for more modded planets.
...
ᵃ: As of 2026-08-03 this mod is not yet available for Factorio 2.1. The compatibility layer for this mod is still included, so if the mod is updated for Factorio 2.1, the compatibility will be applied automatically.
